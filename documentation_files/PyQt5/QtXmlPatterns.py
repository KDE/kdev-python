...
class QAbstractMessageHandler(QObject):
    ...
    def handleMessage(self, type, description, identifier, sourceLocation):
        '''abstract void QAbstractMessageHandler.handleMessage(QtMsgType type, str description, QUrl identifier, QSourceLocation sourceLocation)'''
    def message(self, type, description, identifier = QUrl(), sourceLocation = QSourceLocation()):
        '''void QAbstractMessageHandler.message(QtMsgType type, str description, QUrl identifier = QUrl(), QSourceLocation sourceLocation = QSourceLocation())'''
...
class QAbstractXmlNodeModel():
    ...
    def stringValue(self, n):
        '''abstract str QAbstractXmlNodeModel.stringValue(QXmlNodeModelIndex n)'''
        return str()
    def name(self, ni):
...
class QAbstractXmlReceiver():
    ...
    def processingInstruction(self, target, value):
        '''abstract void QAbstractXmlReceiver.processingInstruction(QXmlName target, str value)'''
    ...
    def comment(self, value):
        '''abstract void QAbstractXmlReceiver.comment(str value)'''
...
class QSimpleXmlNodeModel(QAbstractXmlNodeModel):
    ...
    def stringValue(self, node):
        '''str QSimpleXmlNodeModel.stringValue(QXmlNodeModelIndex node)'''
        return str()
...
class QXmlSerializer(QAbstractXmlReceiver):
    ...
    def processingInstruction(self, name, value):
        '''void QXmlSerializer.processingInstruction(QXmlName name, str value)'''
    def attribute(self, name, value):
    ...
    def comment(self, value):
        '''void QXmlSerializer.comment(str value)'''
    def characters(self, value):
...
class QXmlFormatter(QXmlSerializer):
    ...
    def processingInstruction(self, name, value):
        '''void QXmlFormatter.processingInstruction(QXmlName name, str value)'''
    def attribute(self, name, value):
    ...
    def comment(self, value):
        '''void QXmlFormatter.comment(str value)'''
    def characters(self, value):
...
class QXmlName():
    ...
    def __init__(self, namePool, localName, namespaceUri = None, prefix = None):
        '''void QXmlName.__init__(QXmlNamePool namePool, str localName, str namespaceUri = '', str prefix = '')'''
    def __init__(self):
    ...
    def fromClarkName(self, clarkName, namePool):
        '''static QXmlName QXmlName.fromClarkName(str clarkName, QXmlNamePool namePool)'''
        return QXmlName()
    def isNCName(self, candidate):
        '''static bool QXmlName.isNCName(str candidate)'''
        return bool()
    def isNull(self):
    ...
    def toClarkName(self, query):
        '''str QXmlName.toClarkName(QXmlNamePool query)'''
        return str()
    def localName(self, query):
        '''str QXmlName.localName(QXmlNamePool query)'''
        return str()
    def prefix(self, query):
        '''str QXmlName.prefix(QXmlNamePool query)'''
        return str()
    def namespaceUri(self, query):
        '''str QXmlName.namespaceUri(QXmlNamePool query)'''
        return str()
...
class QXmlQuery():
    ...
    def setInitialTemplateName(self, name):
        '''void QXmlQuery.setInitialTemplateName(str name)'''
    ...
    def setFocus(self, focus):
        '''bool QXmlQuery.setFocus(str focus)'''
        return bool()
    ...
    def evaluateToString(self):
        '''str QXmlQuery.evaluateToString()'''
        return str()
    def evaluateToStringList(self):
        '''list-of-str QXmlQuery.evaluateToStringList()'''
        return [str()]
    ...
    def bindVariable(self, localName, value):
        '''void QXmlQuery.bindVariable(str localName, QXmlItem value)'''
    def bindVariable(self, localName):
        '''QIODevice QXmlQuery.bindVariable(str localName)'''
        return QIODevice()
    def bindVariable(self, localName, query):
        '''void QXmlQuery.bindVariable(str localName, QXmlQuery query)'''
    def namePool(self):
        '''QXmlNamePool QXmlQuery.namePool()'''
        return QXmlNamePool()
    def setQuery(self, sourceCode, documentUri = QUrl()):
        '''void QXmlQuery.setQuery(str sourceCode, QUrl documentUri = QUrl())'''
    def setQuery(self, sourceCode, documentUri = QUrl()):
...
class QXmlSchema():
    ...
    def __init__(self, other):
        '''void QXmlSchema.__init__(QXmlSchema other)'''
    def networkAccessManager(self):
