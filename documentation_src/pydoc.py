...
</head><body style="font-family:georgia; font-size:10pt;" bgcolor="#f0f0f8">
%s
</body></html>''' % (title, contents)

    def heading(self, title, fgcol, bgcol, extras=''):
        """Format a page heading."""
        return '''<h1 style="border-bottom-color:%s">%s</h1>%s''' % (fgcol, title, extras or '&nbsp;')
    ...
    def section(self, title, fgcol, bgcol, contents, width=6,
        ...
        result = '''<div class="section" style="border-color:%s"><h3 style="border-color:%s">%s</h3>''' % (bgcol, bgcol, title)
        if prelude:
            result = result + '''<div class="prelude">%s</div>''' % (prelude)
    ...
    def multicolumn(self, list, format, cols=3):
    ...
    def docmodule(self, object, name=None, mod=None, *ignored):
        ...
        for i in range(len(parts)-1):
            links.append(
                '<a href="%s.html"><font color="#333333">%s</font></a>' %
