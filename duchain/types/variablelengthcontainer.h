...
class KDEVPYTHONDUCHAIN_EXPORT ListTypeData : public KDevelop::StructureTypeData {
public:
    ListTypeData()
 ...
 */
class KDEVPYTHONDUCHAIN_EXPORT ListType : public KDevelop::StructureType {
public:
...
class KDEVPYTHONDUCHAIN_EXPORT MapTypeData : public ListTypeData {
public:
    MapTypeData()
        : ListTypeData()
        , m_keyType() { }
 ...
 */
class KDEVPYTHONDUCHAIN_EXPORT MapType : public ListType {
public:
